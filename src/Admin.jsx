    ...
    return(
      ...
      <AppBar  className="App-bar"   >
        <Toolbar>
          ...
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 }}style={{color:'black',fontSize:'5vh'}} >
              <img src={lg1} alt="" height={150} width={150} style={{left:'20vh'}} />
              
          </Typography>
          
          <Button color="inherit"onClick={signout} style={{backgroundColor:'red',boxShadow:'4px 4px black',borderRadius:'15px'}} >SignOut</Button>
        </Toolbar>
      </AppBar>
    </Box>
    <br /> <br />
           ...
           <div className="admin-parent"  style={{height:'100vh',marginLeft:'4vh'}} >
            ...
            <br /> <br /><br />   <br /> <br /><br /> 
<Card sx={{ display: 'flex' }} style={{width:"50vh",border:'5px solid black',boxShadow:'6px 6px black',marginTop:'6vh',marginLeft:'5vh'}}>
<CardMedia  
        component="img"
        sx={{ width: 151 }}
        image={img}
        alt="Live from space album cover" style={{borderRadius:'50%',height:'20vh' ,marginTop:'5vh',marginLeft:'2vh'}}
      />
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        <CardContent sx={{ flex: '1 0 auto' }}>
          <Typography component="div" variant="h5" style={{textDecoration:'underline'}}>
           <b> Social Links </b>
          </Typography>
...
<option key={op}>{op}</option>
           ...
           <br /> <br /> <br />  
           <TextField fullWidth label=" Social Media Url" id="fullWidth" value={name}  onChange={handleNameChange} />

           <br /> <br />
           <Button size="large"  onClick={addLink}>Add Link</Button>
...
<CardMedia  
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        <CardContent sx={{ flex: '1 0 auto' }}>
          ...
          <TextField style={{backgroundColor:'white'}} fullWidth label=" Link-Name" id="fullWidth" value={name}  onChange={handleNameChange} />
           <br /> <br /> <br />
           <TextField style={{backgroundColor:'white'}} fullWidth label=" URL" id="fullWidth" value={name}  onChange={handleUrlChange} />
           <br /> <br />
           <Button size="large"  onClick={addLink}>Add Link</Button>
            ...
            <div className="edit"style={{marginTop:'10vh',display:'flex',marginBottom:'1vh',marginLeft:'14vh'}} > <div>
      <Button variant="outlined" onClick={handleClickOpen}style={{borderRadius:'20px',background:'black',marginTop:'5vh'}} >
        Edit
      </Button>
...
defaultValue={About} type="text"fullWidth variant="standard"  onChange={(evt) =>
        ...
        <DialogActions>
          ...
          <Button onClick={handleUpdateInfo}>Submit</Button>
                ...
                <div className="phone1" style={{border:'7px solid black',height:'60vh',width:'35vh',borderRadius:'6vh',backgroundColor:'#ccd5ae',flexWrap:'wrap',overflowWrap:'break-word',overflowY:'auto'}}>
                     <span className="admin-logo" > <b>FIY-Link </b></span>
  ...
  {/* <input type="file" name="image-upload" id="image-upload"  style={{borderRadius:'50%',backgroundColor:'red',width:'10vh'}} /> */}
   ...
   {image ? (
            <img src={URL.createObjectURL(image)} alt="upload image" className="img-display-after"  height={100} width={100}  style={{borderRadius:'50%'}}/>
          ) : (
            <img src="" alt="upload image" className="img-display-before" height={100} width={100} style={{borderRadius:'50%'}} />
          )}
    <input type="file" ref={inputRef} onClick={handleImageChange}
    style={{display:'none'}} />
   </div>
    <span className="Name" style={{display:'flex'}} > <b> {Name} </b> </span>
