...
const Login=()=>{
    ...
    const handlelogin = () => {
        ...
        if (username.trim() === "" || password.trim() === "") {
          ...
          axios.post("http://192.168.0.105:8080/user/auth/login", { "username":username,"password": password })
            .then((response) => {
    ...
    return(
        ...
        <div className="username-grid">
            ...
            <div className="second" style={{backgroundColor:'#0a9396'}}>
                ...
                <h1 id="create"> <b>Create Your FIY-Link </b></h1>
                <span style={{textAlign:'center'}} >  <b>Choose Your FIY-Link username. You can always change it later. </b></span>
  <br /><br /> <br />
...
/>
                ...
                <span id="already-login" > <b>New Account </b> ?<Link to="/registration" style={{color:'white'}} > <b> Sign up </b> </Link> </span>
