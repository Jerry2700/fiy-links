...
const bull = (
  ...
  const toggleTab = (index) => {
    ...
    const save =async() => {
      ...
      axios
      .get("http://192.168.0.108:8080/user/get-visits",  {
        headers: {
    ...
    return(
      ...
      <CardContent>
       ...
       <b>  {analyticList===null ? 'no data ':  analyticList[0].name }
       </b></Typography>
        ...
        {analyticList===null ? 'no data ':  analyticList[0].visited }
        </Typography>
      ...
      <CardContent>
        <Typography sx={{ fontSize: 14 }} color="text.secondary" gutterBottom>
        <b> {analyticList===null ? 'no data ':  analyticList[1].name }
        </b>
        </Typography>
        <Typography variant="h5" component="div">
          Least Clicked Link
        ...
        <Typography sx={{ mb: 1.5 }} color="text.secondary">
        {analyticList===null ? 'no data ':  analyticList[1].visited }
        </Typography>
...
<TableContainer component={Paper} style={{border:'2px solid gray'}}>
      <Table sx={{ minWidth: 300 }} aria-label="caption table">
        ...
        <TableBody>
          {listOfLinks.map((link,index) => (
            <TableRow key={index}>
              <TableCell className="table-name" component="th" scope="row" style={{width:'300px'}}>
                {link.name}
              </TableCell>
              <TableCell className="table-name"  style={{width:'400px',overflow:'hidden',display:'block',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{link.link}</TableCell>
              <TableCell className="table-name" style={{width:'200px'}} >{link.visited}</TableCell>
        ...
        <TableBody>
          {listOfOtherLinks.map((link,index) => (
            <TableRow key={index}>
              ...
              <TableCell className="table-name"  style={{width:'400px',overflow:'hidden',display:'block',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{link.url}</TableCell>
              <TableCell className="table-name" style={{width:'200px'}} >{link.visited}</TableCell>
...
<Pie data={data1} style={{maxHeight:'400vh'}}
    options={options} 
  /> 
</div>
        ...
        <TableBody>
          {listOfProducts.map((link,index) => (
            <TableRow key={index}>
              ...
              <TableCell className="table-name"  style={{width:'400px',overflow:'hidden',display:'block',textOverflow:'ellipsis',whiteSpace:'nowrap'}}>{link.productUrl}</TableCell>
              <TableCell className="table-name" style={{width:'200px'}} >{link.visited}</TableCell>
...
<div className="pie-chart-social" style={{marginLeft:'10vw'}}>
<Pie data={data2} style={{maxHeight:'40vh'}}
    options={options} 
  /> 
</div>
